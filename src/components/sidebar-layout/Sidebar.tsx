...
export default function Sidebar({isOpen}: {isOpen: boolean}) {
    ...
    return <aside id="logo-sidebar" className={"fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform border-r bg-card " + (isOpen ? "translate-x-0" : "-translate-x-full")} aria-label="Sidebar">
