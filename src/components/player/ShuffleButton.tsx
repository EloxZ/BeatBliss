export default function ShuffleButton({onClick, isActive}: {onClick: () => void, isActive: boolean}) {
    return <div onClick={onClick}
        className={"w-9 h-9 bg-card rounded-2xl flex items-center justify-center text-white cursor-pointer hover:bg-accent transition " 
